...
* The Ollama Dev Service now automatically configures the Spring AI OpenAI client to use Ollama's OpenAI-compatible API endpoint when the Spring AI OpenAI module is on the classpath. Learn more about it xref:dev-services:ollama.adoc#_spring_ai_openai_compatibility[here].
